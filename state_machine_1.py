class navigation:
    ...
    def __init__(self):
        ...
        self.stack_reel_count_test = {"a":[0,3,"red"], "b":[0,None,"yellow"],"c":[0,None,"green"], "d":[0,None,"red"]}
        ...
        self.routes = {
            "a":[self.grab_from_pd],#self.go_pd, self.grab_from_pd, self.pd_pu], 
            "b":[ self.grab_from_pu],#self.go_pu, self.grab_from_pu, self.pu_ou],
            "c":[self.grab_from_ou],#self.go_ou, self.grab_from_ou, self.ou_od],
            "d":[self.grab_from_od]#self.go_od, self.grab_from_od]
        }
    '''
